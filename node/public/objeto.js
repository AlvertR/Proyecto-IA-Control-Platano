 ...
 * Por ejemplo si tenemos un platano y una pelota, tenemos dos objetos "Amarillos"
 */
class Objeto {
	//Arreglo que tiene los 10, 100 o 1000 pixeles amarillos que representan este objeto.
	pixeles = [];
	...
	constructor(x, y) {
		//Al crear el objeto con un primer pixel, lo agregamos y las esquinas son representadas por ese pixel
	...
	/**
	 * Regresa verdadero si el pixel enviado esta cerca de este objeto "Amarillo", en cuyo caso
